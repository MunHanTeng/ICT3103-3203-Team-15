...
function CCVal($num, $expm, $expy, $cvv) 
{
 ...
 if (preg_match("/^5[1-5][0-9]{14}$/", $this->__ccNum, $matches)) {
 $this->__ccType = "MASTERCARD";}
 elseif (preg_match("/^4[0-9]{12}([0-9]{3})?$/", $this->__ccNum, $matches)) {
 $this->__ccType = "VISA";}
 elseif (preg_match("/^3[47][0-9]{13}$/", $this->__ccNum, $matches)) {
 $this->__ccType = "AMEX";}
 elseif (preg_match("/^3(0[0-5]|[68][0-9])[0-9]{11}$/", $this->__ccNum, $matches)) {
 $this->__ccType = "DINNERS";}
 elseif (preg_match("/^6011[0-9]{12}$/", $this->__ccNum, $matches)) {
 $this->__ccType = "DISCOVER";}
 elseif (preg_match("/^(3[0-9]{4}|2131|1800)[0-9]{11}$/", $this->__ccNum, $matches)) {
 $this->__ccType = "JCB";}
 elseif (preg_match("/^(5[06-8]|6)[0-9]{10,17}$/", $this->__ccNum, $matches)) {
