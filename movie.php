<html>
    ...
    <body onLoad="backButtonOverride()">
        ...
        $movid =  $_POST['moID'];
        $result = mysqli_query($MySQLiconn, "SELECT * FROM movie WHERE movie_id ='$movid'");
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php
                            $sql = "SELECT DISTINCT cinema.cinema_id, cinema.cinema_name FROM `cinema` WHERE cinema.cinema_id in (SELECT showinfo.cinema_id FROM showinfo WHERE showinfo.movie_id ='$movid')";
                        ...
                        while ($row = mysqli_fetch_assoc($resultCinema)) {
                            ...
                            $sqlDate = "Select DISTINCT showInfo_date from showinfo where movie_id='$movid' and cinema_id='".$row['cinema_id']."'";
                            $resultShow = mysqli_query($MySQLiconn, $sqlDate);
                            while ($date = mysqli_fetch_assoc($resultShow)) {
                                echo '<tr><td>';
                                echo '<p>'.$date['showInfo_date'].'</p>';
                                $sqlTime = "Select * from showinfo where movie_id='$movid' and cinema_id='".$row['cinema_id']."' and showInfo_date='".$date['showInfo_date']."'";
